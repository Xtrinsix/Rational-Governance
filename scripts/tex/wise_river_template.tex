...
%% part 2
% \input{chapters/2.0.0_Principles}
% \input{chapters/2.01.0_doctrines_of_intrinsic_liberty}
% \input{chapters/2.02.0_personal_liberty}
% \input{chapters/2.03.0_regional_liberty}
% \input{chapters/2.04.0_global_liberty}
% \input{chapters/2.05.0_twenty_year_doctrine}
% \input{chapters/2.06.0_doctrine_rational_integrity}
% \input{chapters/2.07.0_doctrine_truth}
% \input{chapters/2.08.0_doctrine_positive_merit}
% \input{chapters/2.09.0_doctrine_responsible_capitalism}
